	...
	overlays : [
		{
			...
			type: 'geojson',
			url: '/profiles/og/modules/custom/map/assets/geomap/open-cities-en.geojson',
			visible: true,
			datatable: true,
			tab: true,
			attributes: {
      ...
      tooltipText: 'Name',
		...
		},
		{
			...
			type: 'geojson',
			url: '/profiles/og/modules/custom/map/assets/geomap/open-national-en.geojson',
			visible: true,
			datatable: true,
			tab: true,
			attributes: {
      ...
      tooltipText: 'Name',
			...
			type: 'geojson',
			url: '/profiles/og/modules/custom/map/assets/geomap/open-provinces-en.geojson',
			visible: true,
			datatable: true,
			tab: true,
			attributes: {
