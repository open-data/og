  ...
  overlays : [
    {
      ...
      type: 'geojson',
      url: '/profiles/og/modules/custom/map/assets/geomap/open-cities-fr.geojson',
      visible: true,
      datatable: true,
      tab: true,
      attributes: {
    ...
    },
    {
      ...
      type: 'geojson',
      url: '/profiles/og/modules/custom/map/assets/geomap/open-national-fr.geojson',
      visible: true,
      datatable: true,
      tab: true,
      attributes: {
      ...
      type: 'geojson',
      url: '/profiles/og/modules/custom/map/assets/geomap/open-provinces-fr.geojson',
      visible: true,
      datatable: true,
      tab: true,
      attributes: {
