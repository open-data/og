    ...
    public function submitForm(array &$form, FormStateInterface $form_state, WebformSubmissionInterface $webform_submission)
    {
        ...
        if (in_array($rating, [1,2,3,4,5])) {
            ...
            try {
                ...
                $new_average = ($vote_average * $vote_count
                + $form_state->getValue('rating'))
                / $new_count;
                ...
                \Drupal::logger('vote')->
                warning(
                    'Vote-Vote Up or LIKE (external): Exception thrown while trying to update vote count for uuid: '
                    . $uuid . '\n'
                    . $e->getMessage()
                );
            }
